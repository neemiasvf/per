...
### RVM
set :rvm_ruby_version, 'ruby-2.4.1@per'
...
# Symlinks Rails shared files and directories
...
# No default value
set :nginx_domains, 'per.neemiasvf.me server.neemiasvf.me neemiasvf.me'

# Redirected domains, all these will have a permanent redirect to the first of :nginx_domains
# No default value
set :nginx_redirected_domains, 'server.neemiasvf.me neemiasvf.me'
